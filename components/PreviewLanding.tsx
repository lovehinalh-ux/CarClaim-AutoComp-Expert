...
const PreviewLanding: React.FC<Props> = ({ onStart }) => {
  return (
    <div className="min-h-screen bg-stone-50 flex flex-col items-center justify-center p-4 animate-in fade-in duration-700">
      <div className="max-w-2xl w-full bg-white rounded-[2rem] shadow-2xl shadow-stone-200 border border-stone-100 overflow-hidden">
        ...
        <div className="p-8 md:p-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
            <div className="flex gap-4 p-5 rounded-2xl bg-stone-50 border border-stone-200 items-start group hover:border-red-200 transition-colors">
              ...
              <div>
                <h3 className="font-black text-stone-900 text-lg mb-1">精準試算</h3>
            ...
            <div className="flex gap-4 p-5 rounded-2xl bg-stone-50 border border-stone-200 items-start group hover:border-red-200 transition-colors">
              ...
              <div>
                <h3 className="font-black text-stone-900 text-lg mb-1">專家把關</h3>
                <p className="text-sm text-stone-600 font-medium leading-relaxed">內建 2026 最新法規數據與實務判決建議。</p>
              </div>
            </div>
          </div>

          <div className="space-y-4 mb-10 pl-2">
            <div className="flex items-center gap-3 text-stone-700 group">
            ...
            <div className="flex items-center gap-3 text-stone-700 group">
              ...
              <span className="font-medium text-stone-500">隱私安全：所有計算均在本地完成，不儲存資料</span>
            </div>
          </div>
